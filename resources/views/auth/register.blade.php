        ...
        <section class="auth">
            <div class="block">
                ...
                <form class="form" method="POST" action="/register">
                    ...
                    <div class="grid">
                        <div class="field">
                            <label class="label" for="auth-name"> Имя</label>

                            <div class="control-row">
                                <input type="text" class="input primary size-md rounded-sm" id="auth-name" name="name" placeholder="Имя" />
                            </div>
                        </div>
                        ...
                        <div class="field">
                            <label class="label" for="auth-password_confirmation"> Пароль</label>

                            <div class="control-row">
                                <input type="password" class="input primary size-md rounded-sm" id="auth-password_confirmation" name="password_confirmation" placeholder="••••••••" autocomplete="current-password" />
                            </div>
                        </div>
